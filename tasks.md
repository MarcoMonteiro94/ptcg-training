...
- [ ] **T4: Performance audit** — Analisar bundle size, lazy load heavy components, otimizar images (next/image), verificar Core Web Vitals.
- [ ] **T5: E2E test suite** — Playwright tests para fluxos: home, deck listing, deck detail, journal, training setup.
